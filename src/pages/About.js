    ...
    <div className="AboutDiv">
      <div className="About-Picture">
        <div id="profile" className="Samonim">
          ...
          <div className="links">
            <a
              href="https://www.gracecov.org/gcck-grace-covenant-church-korean/%EA%B5%90%ED%9A%8C%EC%86%8C%EA%B0%9C-about-us/gcck-staff-%EC%8A%A4%ED%85%8C%ED%94%84/member-detail/1663889/?group=korean-site-pastors"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="https://i.imgur.com/uPTdl85.png"
                className="linked"
                alt="..."
              />
            </a>
        ...
        <div id="profile" className="kim">
          ...
          <div className="links">
            <a
              href="https://www.linkedin.com/in/min-yong-kim-0226//"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
